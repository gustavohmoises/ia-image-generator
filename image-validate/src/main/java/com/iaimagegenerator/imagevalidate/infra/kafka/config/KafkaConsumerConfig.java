package com.iaimagegenerator.imagevalidate.infra.kafka.config;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, ImageRequestDTO> consumerFactory() {
        ...
        configs.put(ConsumerConfig.GROUP_ID_CONFIG,"image-validate-group");
        ...
        configs.put(JacksonJsonDeserializer.VALUE_DEFAULT_TYPE, "com.ia_image_generator.image_validate.dto.ImageRequestDTO");
